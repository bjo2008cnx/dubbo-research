 ...
 *
 * url example: <ul> <li>http://www.facebook.com/friends?param=value1 <li>http://username:password@10.20.130.230:8080/list?version=1.0.0
 * <li>registry://192.168.1.7:9090/com.alibaba.service1?param1=value1&param2=value2 <li>ftp://username:password@192.168.1.7:21/1/read.txt
 * <li>file:///home/user1/router.js?type=script<br> for this case, url protocol = null, url host = null, url path = /home/user1/router.js
 * <li>file:///D:/1/router.js?type=script<br> for this case, url protocol = null, url host = null, url path = /D:/1/router.js </ul>
 *
...
public final class URL implements Serializable {
  ...
  public URL(String protocol, String username, String password, String host, int port, String path, Map<String, String> parameters) {
    ...
    this.parameters = Collections
        .unmodifiableMap(parameters != null ? new HashMap<String, String>(parameters) : new HashMap<String, String>(0));
  }
