...
/**
 * PojoUtils. Travel object deeply, and convert complex type to simple type. <p> Type below will be remained: <ul> <li> Primitive Type, also
 * include <b>String</b>, <b>Number</b>(Integer, Long), <b>Date</b> <li> Array of Primitive Type <li> Collection, eg: List, Map, Set etc.
 * </ul> <p> Other type will be covert to a map which contains the attributes and value pair of object.
 *
  ...
  private static Object realize(Object pojo, Class<?> type, Type genericType, final Map<Integer, Object> history) {
    ...
    if (pojo instanceof Map<?, ?> && type != null) {
      ...
      if (Map.class.isAssignableFrom(type) || type == Object.class) {
        ...
        Object dest = Proxy
            .newProxyInstance(Thread.currentThread().getContextClassLoader(), new Class<?>[]{type}, new PojoInvocationHandler(map));
        history.put(id, dest);
        return dest;
      } else {
              ...
              if (method != null) {
                ...
                try {
                  ...
                  throw new RuntimeException(
                      "Failed to set pojo " + dest.getClass().getSimpleName() + " property " + name + " value " + value + ", cause: " + e
                          .getMessage(), e);
                }
              }
            }
