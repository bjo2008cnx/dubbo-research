...
public class JSONWriterTest extends TestCase {
  ...
  public void testWriteJson() throws Exception {
    ...
    // write object.
    w.getBuffer().setLength(0);
    writer.objectBegin().objectItem("type").valueString("com.alibaba.dubbo.TestService").objectItem("version").valueString("1.1.0")
        .objectEnd();
    ...
    writer.objectItem("service").objectBegin().objectItem("type").valueString("com.alibaba.dubbo.TestService").objectItem("version")
