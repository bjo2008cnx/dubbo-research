...
public class ScriptRouter implements Router {
  ...
  public <T> List<Invoker<T>> route(List<Invoker<T>> invokers, Invocation invocation) throws RpcException {
    try {
      ...
      logger.error("route error , rule has been ignored .rule :" + rule + ",invocation:" + invocation + ",url :" + (
          RpcContext.getContext().getInvoker() == null ? "" : RpcContext.getContext().getInvoker().getUrl()), e);
      return invokers;
    }
  }
