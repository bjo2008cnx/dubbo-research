...
/**
 * 快速失败，只发起一次调用，失败立即报错，通常用于非幂等性的写操作。</br> <a href="http://en.wikipedia.org/wiki/Fail-fast">Fail-fast</a>
 *
  ...
  public Result doInvoke(Invocation invocation, List<Invoker<T>> invokers, LoadBalance loadbalance) throws RpcException {
    ...
    try {
      ...
      throw new RpcException(
          "Failfast invoke providers " + invoker.getUrl() + " " + loadbalance.getClass().getAnnotation(Extension.class).value()
