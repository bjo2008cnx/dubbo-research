  ...
  private ExchangeHandler requestHandler = new ExchangeHandlerAdapter() {
    ...
    public Object reply(ExchangeChannel channel, Object message) throws RemotingException {
        ...
        if (exporter == null) {
          throw new RemotingException(channel,
              "Not found exported service: " + serviceKey + " in " + exporterMap.keySet() + ", may be version or group mismatch "
                  + ", channel: consumer: " + channel.getRemoteAddress() + " --> provider: " + channel.getLocalAddress() + ", message:"
                  + message);
        }
        ...
        if (isCallBackServiceInvoke) {
          ...
          if (!hasMethod) {
            logger.warn(new IllegalStateException("The methodName " + inv.getMethodName()
                + " not found in callback service interface ,invoke will be ignored. please update the api interface. url is:" + exporter
                .getInvoker().getUrl()) + " ,invocation is :" + inv);
            return null;
          }
        }
      ...
      throw new RemotingException(channel, "Unsupported request: " + message == null ? null
          : (message.getClass().getName() + ": " + message) + ", channel: consumer: " + channel.getRemoteAddress() + " --> provider: "
