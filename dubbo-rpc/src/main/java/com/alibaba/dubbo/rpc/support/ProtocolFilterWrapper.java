...
public class ProtocolFilterWrapper implements Protocol {
  ...
  public <T> Exporter<T> export(Invoker<T> invoker) throws RpcException {
    ...
    return protocol.export(
        buildInvokerChain(invoker, invoker.getUrl().getParameter(Constants.SERVICE_FILTER_KEY), RpcConstants.DEFAULT_SERVICE_FILTERS));
  }
  ...
  public <T> Invoker<T> refer(Class<T> type, URL url) throws RpcException {
    ...
    return buildInvokerChain(protocol.refer(type, url), url.getParameter(Constants.REFERENCE_FILTER_KEY),
        RpcConstants.DEFAULT_REFERENCE_FILTERS);
  }
