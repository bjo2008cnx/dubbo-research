 ...
 */
public class ServiceBean<T> extends ServiceConfig<T> implements InitializingBean, ApplicationContextAware, ApplicationListener,
    BeanNameAware {
    ...
    if (applicationContext != null) {
      ...
      try {
        Method method = applicationContext.getClass()
            .getMethod("addApplicationListener", new Class<?>[]{ApplicationListener.class}); // 兼容Spring2.0.1
  ...
  public void afterPropertiesSet() throws Exception {
    if (getProvider() == null) {
      Map<String, ProviderConfig> providerConfigMap =
          applicationContext == null ? null : applicationContext.getBeansOfType(ProviderConfig.class, false, false);
      if (providerConfigMap != null && providerConfigMap.size() > 0) {
        ...
        if (providerConfigs.size() > 1) {
          Map<String, ProtocolConfig> protocolConfigMap =
              applicationContext == null ? null : applicationContext.getBeansOfType(ProtocolConfig.class, false, false);
    ...
    if (getApplication() == null
      ...
      Map<String, ApplicationConfig> applicationConfigMap =
          applicationContext == null ? null : applicationContext.getBeansOfType(ApplicationConfig.class, false, false);
    ...
    if (getRegistries() == null || getRegistries().size() == 0
      ...
      Map<String, RegistryConfig> registryConfigMap =
          applicationContext == null ? null : applicationContext.getBeansOfType(RegistryConfig.class, false, false);
    ...
    if (getMonitor() == null
      ...
      Map<String, MonitorConfig> monitorConfigMap =
          applicationContext == null ? null : applicationContext.getBeansOfType(MonitorConfig.class, false, false);
